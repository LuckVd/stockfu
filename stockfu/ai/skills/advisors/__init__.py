...
from stockfu.ai.skills.advisors.risk import RiskAdvisor
from stockfu.ai.skills.advisors.trend import TrendAdvisor
from stockfu.ai.skills.advisors.valuation import ValuationAdvisor
