...
_OP_NAMES = {
    ...
    # 2026-08 新增(网络调研流行策略,见 docs/STRATEGY_RESEARCH_2026.md):
    "fifty_two_week_high": "52周新高", "ts_momentum": "时序动量",
    "momentum_acceleration": "动量加速", "donchian_breakout": "唐奇安突破",
    "lottery_max": "MAX彩票股", "low_beta": "低贝塔", "size": "小市值",
    "low_turnover": "低换手", "illiquidity": "Amihud流动性", "graham_value": "格雷厄姆价值",
}
...
_STRATEGIES = [
    ...
    "dividend_cross_section_partial_exposure_brake_regime_vol_take_profit",
    "dividend_cross_section_partial_exposure_brake_regime_trendvol_take_profit",
    # 2026-08 网络调研新增策略族(详见 docs/STRATEGY_RESEARCH_2026.md):
    "fifty_two_week_high_cross_section",
    ...
    "donchian_breakout_cross_section",
