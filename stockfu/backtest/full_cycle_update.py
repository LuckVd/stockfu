...
def run_one(
    ...
    *,
    ...
    return {
        ...
        "underwater_days_gt0": m.get("underwater_days_gt0"),
        "underwater_days_ge10": m.get("underwater_days_ge10"),
        "underwater_days_ge20": m.get("underwater_days_ge20"),
        "underwater_days_ge30": m.get("underwater_days_ge30"),
